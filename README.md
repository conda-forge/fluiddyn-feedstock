...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6517&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/fluiddyn-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `fluiddyn` can be installed with `conda`:
...
It is possible to list all of the versions of `fluiddyn` available on your platform with `conda`:
...
```
mamba search fluiddyn --channel conda-forge
```
...
mamba repoquery search fluiddyn --channel conda-forge

# List packages depending on `fluiddyn`:
mamba repoquery whoneeds fluiddyn --channel conda-forge

# List dependencies of `fluiddyn`:
mamba repoquery depends fluiddyn --channel conda-forge
```
